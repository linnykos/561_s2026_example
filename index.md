...
This is a demo package for UW BIOST 561 (Spring 2026), taught by Kevin
Lin.

- The URL to the GitHub (i.e., the source code) is:
  <https://github.com/linnykos/561_s2026_example>
- The URL to the Pkgdown webpage is:
  <https://linnykos.github.io/561_s2026_example/>

# How to install

This package is called `UWBiost561`. To install, run the following code
(in R):
